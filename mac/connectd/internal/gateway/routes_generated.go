...
var getPaths = map[string]bool{
	...
	"/postures":                     true,
	"/power-state":                  true,
	"/provider-controls/snapshot":   true,
	"/provider-controls/stream":     true,
	...
	"/session-control/v1/events":    true,
	"/session-control/v1/snapshot":  true,
...
var postPaths = map[string]bool{
	...
	"/postures":                              true,
	"/provider-controls/execute":             true,
	"/providers/visibility":                  true,
	...
	"/session-control/v1/execute":            true,
	"/session-control/v1/negotiate":          true,
	"/session-control/v1/recover":            true,
